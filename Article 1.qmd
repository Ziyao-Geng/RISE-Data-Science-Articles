...
subtitle: "A beginner-friendly introduction to using R for research and reproducible data analysis"
...
![Example of a code chunk](figures/code_chunk.png)
...
Here, `c()` means “combine.” It creates a vector containing multiple values. We can then apply statistical analysis functions on the vectors:
