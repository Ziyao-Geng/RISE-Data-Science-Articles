...
## Appendix
1. [Download rise_sample_health_data.csv](data/rise_sample_health_data.csv)
2. [Download the QMD file used to create this article](article_01_getting_started_with_r.qmd)
